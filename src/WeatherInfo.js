...
export default function WeatherInfo(props) {
  ...
  return (
    <div className="row">
      <div className="col-md-7 weather-info">
        ...
        <div className="weather-description mt-4">
          <span className="weather-details me-4">
            Feels like:{" "}
            <Temperature celsius={props.data.feelsLike} unit={unit} />°
          </span>
          <span className="weather-details me-4">
            Humidity: {props.data.humidity}%{" "}
          </span>
          <span className="weather-details">Wind: {props.data.wind} km/h</span>
        </div>
      </div>
      <div className="col-md-5 forecast-section">
